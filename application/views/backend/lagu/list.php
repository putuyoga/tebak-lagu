<?php
	...
	$link_hapus = base_url('index.php/administrator/lagu/hapus');
	$link_edit = 'index.php/administrator/lagu/edit/';
	$link_list = base_url('index.php/administrator/lagu/lists');
	$link_hapus_semua = base_url('index.php/administrator/lagu/hapus_semua');
	$link_tambah = base_url('index.php/administrator/lagu/tambah');
?>
